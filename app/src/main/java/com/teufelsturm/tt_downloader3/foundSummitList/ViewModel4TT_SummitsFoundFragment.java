...
public class ViewModel4TT_SummitsFoundFragment extends AndroidViewModel {
    ...
    public int intMinAnzahlDerWege = 0;
    public int intMaxAnzahlDerWege = 250;
    public int intMinAnzahlDerSternchenWege = 0;
    public int intMaxAnzahlDerSternchenWege = 100;
    ...
    MutableLiveData<ArrayList<TT_Summit_AND>> getLstTT_Route_AND() {
        if (lstTT_Summit_AND == null) {
            ...
            lstTT_Summit_AND.setValue(new ArrayList<TT_Summit_AND>());
