...
public class ViewModel4TT_SummitFoundFragment extends AndroidViewModel {
    ...
    MutableLiveData<TT_Summit_AND> getaTT_Summit_AND() {
        return aTT_Summit_AND;
    }
    void setaTT_Summit_AND(TT_Summit_AND aTT_Summit_AND) {
    ...
    Map<Integer, String> hashmapNeighbourSummit = new HashMap<>();
            ...
            if (cursor != null) {
                ...
                if (cursor.moveToFirst()) {
                    do {
                        ...
                        tt_route_andMutableLiveData.addSource(int_typeAsscended, integer -> {
                            Log.e(TAG, "public void onChanged(Integer integer) {: <" + integer + ">");
                            lstTT_Route_AND.postValue(lstTT_Route_AND.getValue());
                        });
                        tt_route_andMutableLiveData.addSource(long_DateAsscended, aLong -> {
                            Log.e(TAG, "public void onChanged(Long aLong) {: <" + aLong + ">");
                            lstTT_Route_AND.postValue((lstTT_Route_AND.getValue()));
                        });
                        tt_route_andMutableLiveData.addSource(str_Comment, s -> {
                        ...
                        lstTT_Route_AND.addSource(tt_route_andMutableLiveData, tt_route_and -> {
