...
import com.teufelsturm.tt_downloader_kotlin.results.adapter.RouteDetailAdapter
import com.teufelsturm.tt_downloader_kotlin.results.adapter.util.RouteCommentsClickListener
import com.teufelsturm.tt_downloader_kotlin.results.vm.RouteDetailResultViewModel
...
class RouteDetailResultFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        args.eventSearchRouteParameter.intTTWegNr?.let { intTTWegNr ->
            viewModel.queryData(
                intTTWegNr = intTTWegNr,
                intTTGipfelNr = args.eventSearchRouteParameter.intTTSummitNr
            )
        }
    ...
    override fun onCreateOptionsMenu(menu: Menu, inflater: MenuInflater) {
        inflater.inflate(R.menu.detail_result, menu)
    }
