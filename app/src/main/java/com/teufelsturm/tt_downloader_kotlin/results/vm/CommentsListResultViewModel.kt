...
import com.teufelsturm.tt_downloader_kotlin.results.ui.CommentsListResultFragmentArgs
import com.teufelsturm.tt_downloader_kotlin.results.vm.generics.ViewModelCommentOrderWidget
...
class CommentsListResultViewModel @Inject constructor(
    ...
    private suspend fun queryRoutesAsync(
        ...
        with(args.eventSearchCommentParameter) {
