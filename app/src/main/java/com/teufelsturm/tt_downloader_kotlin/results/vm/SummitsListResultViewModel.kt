...
import com.teufelsturm.tt_downloader_kotlin.results.ui.SummitsListResultFragmentArgs
import com.teufelsturm.tt_downloader_kotlin.results.vm.generics.ViewModelSummitOrderWidget
...
class SummitsListResultViewModel @Inject constructor(
    ...
    private suspend fun querySummitsAsync(
        ...
        with(args.eventSearchSummitParameter) {
