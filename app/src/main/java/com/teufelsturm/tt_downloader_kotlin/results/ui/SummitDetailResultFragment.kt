...
import com.teufelsturm.tt_downloader_kotlin.results.vm.SummitDetailResultViewModel
...
class SummitDetailResultFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        viewModel.queryData(args.eventNavigatingToSummit.intTTSummitNr)
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        return when (item.itemId) {
            ...
            R.id.summit_detail_menu_add -> {
                Toast.makeText(context, "Editieren gedrückt!", Toast.LENGTH_LONG).show()
                true
            }
