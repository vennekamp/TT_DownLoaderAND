    ...
    override fun onCreateView(
        ...
        viewPager.registerOnPageChangeCallback(object : ViewPager2.OnPageChangeCallback() {
            ...
            override fun onPageSelected(position: Int) {
                ...
                val myFragment0 = childFragmentManager.findFragmentByTag("f0")
                val myFragment1 = childFragmentManager.findFragmentByTag("f1")
                val myFragment2 = childFragmentManager.findFragmentByTag("f2")

//                (myFragment0 as SummitSearchFragment?)?.setActionBarTitle(position == 0)
//                (myFragment1 as RouteSearchFragment?)?.setActionBarTitle(position == 1)
//                (myFragment2 as CommentSearchFragment?)?.setActionBarTitle(position == 2)
            }
        })
    ...
    private fun consumeBundledArgs(
        ...
        val args = arguments?.let { TabOfSearchesFragmentArgs.fromBundle(it) }
        args?.startTab?.let {
     ...
     * sequence.
     */
    private inner class SearchesAdapter(val fa: Fragment) : FragmentStateAdapter(fa) {
