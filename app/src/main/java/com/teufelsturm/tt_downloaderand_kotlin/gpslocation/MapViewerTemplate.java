...
public abstract class MapViewerTemplate extends Activity {
    ...
    protected void createControls() {
        initializePosition(mapView.getModel().mapViewPosition.getMapPosition());
    }
     ...
     */
    protected MapPosition initializePosition(MapPosition mvp) {
        LatLong center = mvp.latLong;

        if (center.equals(new LatLong(0, 0))) {
            mvp = this.getInitialPosition();
        }
