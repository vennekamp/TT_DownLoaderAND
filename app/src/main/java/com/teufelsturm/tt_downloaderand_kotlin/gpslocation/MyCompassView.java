...
public class MyCompassView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.currentLocation != null) {
            ...
            yPoint = drawMulitiLineText(aString, xPoint, yPoint, canvas);
            drawMulitiLineText(aString, xPoint, yPoint, canvas);
        } else {
    ...
    private int drawMulitiLineText(@NotNull String aString, int xPoint, int yPoint,
                                   Canvas canvas) {
     ...
     *
     * @param newLocation a GPS Location, as readable from the mobile device
     */
