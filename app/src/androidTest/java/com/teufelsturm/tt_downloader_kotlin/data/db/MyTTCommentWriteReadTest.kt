...
class MyTTCommentWriteReadTest {
...
//            .build()
    ...
    fun SimpleTestOfMyTTRouteDAOReadWrite() {
        val myTTCommentAND: MyTTCommentAND = MyTTCommentAND(myIntTTWegNr = -100, myIntTTGipfelNr = -100 ).apply {
            Id = 0L
            isAscendedType = 8
        ...
        val back1 = runBlocking { myTTCommentDAO.getMyTTCommentANDByID(myTTCommentAND.Id).first() }
        ...
        val back2 = runBlocking { myTTCommentDAO.getMyTTCommentANDByID(back1.Id).first() }
        assertThat(back2.myIntTTWegNr).isEqualTo(-100)
        assertThat(back2.isAscendedType).isEqualTo(8)
    ...
    fun TestOfMyTTRouteDAOViaCode() {
        ...
        val myTTCommentAND: MyTTCommentAND = MyTTCommentAND(myIntTTGipfelNr =-123, myIntTTWegNr = 123 ).apply {
            Id = -123
            isAscendedType = 9
        ...
        val myTT_RoutePhotos_AND0 = MyTTCommentPhotosAND().apply {
            Id = 0
